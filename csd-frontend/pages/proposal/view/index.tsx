...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  const head = await getHeader("Proposal");
  const data = await getData("proposals", head);
    ...
    <div>
      <Header>
        <div className="mb-2 mt-10 flex justify-between items-center">
          ...
          <Link href="/proposal/create" className="col-span-1">
            <CButton>Create Proposal</CButton>
          </Link>
        </div>
      </Header>
