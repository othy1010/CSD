...
describe('Mitigation routing resolve service', () => {
  ...
  let resultMitigation: IMitigation | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultMitigation).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IMitigation>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
