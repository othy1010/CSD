...
class ApplicationResourceIT {
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return application;
    }
    ...
    public static Application createUpdatedEntity(EntityManager em) {
        Application application = new Application().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return application;
    }
    ...
    void putExistingApplication() throws Exception {
        ...
        updatedApplication.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
